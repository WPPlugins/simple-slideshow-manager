...
<p><?php _e('If you are facing any issues, kindly post them at plugins support forum','simple-slideshow-manager');?> <a href="http://wordpress.org/support/plugin/<?php echo ACX_FSMI_WP_SLUG; ?>/" target="_blank"><?php _e('here','simple-slideshow-manager'); ?></a>
</div>
</div> <!-- acx_slideshow_sidebar_widget -->
