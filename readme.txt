...
The Easy and Best Slideshow Manager Plugin Where you can create any number of slideshow. Can have any number of video or image slides, Enjoy displaying slideshow using widgets, shortcodes or php codes.

A Quicklook

	★ Unlimited Responsive Slideshows
...
An Easy to use slideshow plugin which help you to include multi device friendly slideshows in your wordpress website or blog. Slideshow can be on your header, sidebar as widget or widget slideshow in footer or anywhere in your posts or pages.
...
Yes, You needs to set a higher width for the slideshow and it will then act as responsive slideshow.
...
1. Simple Slideshow Manager Settings
2. Manage Gallery Page
3. Shortcode/PHP Code Generator Page.
4. Simple Slideshow Manager Widget Options.
5. Simple Slideshow Manager Edit Slide/Add Link to Slide Option.
6. Simple Slideshow Manager Slideshow - Responsive Preview
...
= 2.1 =
* June 29, 2015 | Bug Fixes, Stable Release
* CSS Fix
* Fixed Bug on Responsive Animation
* Optimized Sliding javascript
* Performance Improvements

= 2.0 =
* June 13, 2015 | Bug Fixes, Stable Release
* CSS Fix
* Optimized Rename Gallery Code Using Ajax
* Add Next And Previous Buttons 
* Responsive Slides
* Validating The New Gallery Name
* Validating  Advanced Settings
* Fixed Bug - Optimized Sliding javascript
* Fixed Bug - Videos are automatically played on browser chrome
* Fixed Minor Bugs
* Performance Improvements
* Code Improvements
